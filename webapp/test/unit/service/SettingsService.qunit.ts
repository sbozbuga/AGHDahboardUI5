...
QUnit.skip("setBaseUrl allows valid URLs", function (assert) {
...
QUnit.skip("setBaseUrl throws on invalid URLs", function (assert) {
	const service = SettingsService.getInstance();
	...
	assert.throws(
		...
		"Throws on embedded credentials"
	);
});

QUnit.skip("setBaseUrl throws on URLs with query params or fragments", function (assert) {
	const service = SettingsService.getInstance();
